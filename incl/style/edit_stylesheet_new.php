...
<form method="post" action="">
  <fieldset>
    ...
    <p>
		<!-- Retrieves stylesheet and loads it in textarea. -->
	...
	<?php 
		if($isWritable){
			echo '<p class="info">Filen är skrivbar.</p>';
		}else{
			echo '<p class="info">Filen är ej skrivbar. Gör den skrivbar med chmod 666 för att göra det möjligt att editera filen och spara dina ändringar.</p>';
		}
	?>
